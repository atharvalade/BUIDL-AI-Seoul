...
export const metadata = {
  title: "TrueLens - Verified News for Better Trading",
  description:
    "TrueLens is a platform for verifying news from multiple sources to help you make better trading decisions.",
